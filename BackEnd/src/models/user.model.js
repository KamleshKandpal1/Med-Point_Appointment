...
export default mongoose.model("user", userSchema); // works well if the model is only defined and imported in one file throughout your application

// const userModel = mongoose.model.user || mongoose.model("user", userSchema); // works well if the model is imported in multiple files
